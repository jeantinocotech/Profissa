        ...
        <div class="p-6">
            ...
            <div class="mb-6 bg-gray-50 rounded-lg p-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-700">{{ $request->proposal->finder_comment }}</p>
                </div>
                ...
                <div class="mb-4">
                    <h3 class="font-medium mb-2">Proposed date/time:</h3>
                    <p class="text-gray-700">{{ \Carbon\Carbon::parse($request->proposal->proposed_datetime)->format('d/m/Y H:i')}}</p>
                </div>
            </div>

            <form action="{{ route('meeting-proposal.confirm',  $request->proposal->id) }}" method="POST">
                @csrf
