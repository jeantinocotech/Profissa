...
public function search(Request $request)
{
    ...
    $skillMatches = DB::table('profiles_advisor')
        ->join('advisor_skills', 'profiles_advisor.id', '=', 'advisor_skills.advisor_id')
        ->whereIn('advisor_skills.skill_id', $selectedSkillIds)
    ...
    return view('matches', ['matchingAdvisors' => $combined]);
}
